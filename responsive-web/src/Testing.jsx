        ...
        <div className="n-container">
            <div className="n-company">
                <span className="n-logo">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox={company.viewBox}> <path d={company.svgpath} /> </svg>
                </span>
                <span className="n-name">{company.name}</span>
            </div>
            <div className="n-content">
                {
                    datas.map((value, key) => {
                        return (
                            <div
                                className={`n-item ${value.submenu != "" ? "space-between" : "flex-start"}`}
                                key={key}>
                                <span className="n-item-logo">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox={value.viewBox}> <path d={value.svgpath} /> </svg>
                                </span>
                                <span className="n-item-name">{value.linkname}</span>
                                {
                                    value.submenu != "" ?
                                        <span className="n-item-arrow">
            ...
            <div className="n-user-card">
                <span className="n-user-img">
                    <img className="profile" src={profile} alt="profile" />
                </span>
                <span className="n-user">
                    <span className="n-user-name">{user.name}</span>
                    <span className="n-user-job">{user.job}</span>
                </span>
                <span className="n-logout">
                    <svg className="n-logout-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
